...
*/
  ...
  ionViewDidLoad() {
    ...
    //drawSpielfigur(StageScaleX, StageScaleY) {
    ...
    this.corpus.graphics.setStrokeStyle(25)
      .beginStroke("#000000")
      .beginFill('#936037')
      .drawCircle(0, 0, 1000)
      .endFill()
    ...
    this.innerleftEar.graphics.setStrokeStyle(25)
      .beginStroke('white')
      .beginFill('#ffffff')
    ...
    this.innerrightEar.graphics.setStrokeStyle(25)
      .beginStroke('white')
      .beginFill('#ffffff')
      .arc(0, 0, 150, 0, ((Math.PI * 2) / 360) * 180, true)
      .endFill()
    ...
    this.nose.graphics.setStrokeStyle(25)
      .beginStroke('#000000')
      .beginFill('#000000')
    ...
    this.restrightEyeAusschnitt.graphics.setStrokeStyle(25)
      .beginStroke()
      .beginFill("white")
      .arc(coords2.x, coords2.y, 1000, (Math.PI / 180) * 82, (Math.PI / 180) * 40, true)
      .endFill()
      .endStroke();
    //this.restrightEyeAusschnitt.y-=3;
